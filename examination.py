...
def examine(filename, folder_name=""):
    DEBUG = False
    project_name = ""
    name = ""
    if folder_name == "":
        project_name = "results/" + filename + "/"
        name = "samples/" + filename + ".jpg"
        if not os.path.exists("results/" + filename):
            os.makedirs("results/" + filename)
    else:
        project_name = "results/" + filename + "/"
        name = "samples/" + folder_name + "/" + filename + ".jpg"
        if not os.path.exists("results/" + filename):
            os.makedirs("results/" + filename)
        if not os.path.exists("samples/" + folder_name):
            os.makedirs("samples/" + folder_name)
